...
* **August 2025**: No major update, just letting you know that I still periodically check in on the IPv6 status. Virgin Media is unlikely to deploy IPv6 to the older HFC/DOCSIS network, but as the [full fibre XGS-PON network upgrade](https://www.ispreview.co.uk/index.php/2025/03/virgin-media-uk-start-making-xgs-pon-full-fibre-upgrade-available.html) is taking place, there may be hope in the future, but we've heard that before...
